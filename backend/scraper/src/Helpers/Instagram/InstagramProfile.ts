...
import { insertInstagramProfile } from "../mongoUtils.js"; // Assuming this is your MongoDB utility function

// Exported async function
export async function scrapeInstagramProfiles(startUrls: string[]) {
    const endpoint =
        "https://api.apify.com/v2/acts/apify~instagram-profile-scraper/run-sync-get-dataset-items?token=apify_api_PX0pmbuYEg3gO4cHjqIb8D8ah9MOnr2lJs5D";
    const data = {
        usernames: startUrls,
    };
