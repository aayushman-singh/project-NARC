...
const Home = () => {
  ...
  return (
    <div className="relative text-white">
      ...
      <div className="relative z-10">
        ...
        <section id="about" className="min-h-screen flex flex-col justify-center items-center px-4 py-16 text-white">
          <div className="container mx-auto">
            <h2 className="text-7xl font-bold mb-12 text-center">Who We Are</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card icon={<ShieldIcon />} title="Secure Investigation" className="card">
                Our Social Media Investigator Tool is designed to enhance digital forensics in law enforcement investigations.
              </Card>
              <Card icon={<SearchIcon />} title="Comprehensive Analysis" className="card">
              ...
              <Card icon={<FileTextIcon />} title="Automated Documentation" className="card">
            ...
            <p className="text-lg text-gray-300 max-w-4xl mt-12 text-center mx-auto">
              Available in both Android and Windows versions, our tool ensures compatibility with various examination scenarios.
            </p>
          </div>
        </section>

        <section id="services" className="min-h-screen w-full flex items-center justify-center py-20">
  <div className="container mx-auto px-4">
    ...
    <p className="text-xl sm:text-2xl text-gray-300 mt-4 max-w-3xl mx-auto text-center mb-12">
      Our comprehensive services cover data scraping, tracking, and investigative reporting on major social media platforms.
    </p>
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      <Card title="Instagram Investigation" icon={<InstagramIcon />}>
        Track hashtags, users, posts, and messages to uncover drug-related activities.
      </Card>
...
>
  Explore Services
        ...
        <section id="team" className="min-h-screen flex flex-col justify-center items-center py-20">
          <div className="container mx-auto px-4">
            <h2 className="text-7xl font-bold text-center bg-clip-text text-transparent text-white mb-8">
              Meet Our Team
            </h2>
            <p className="text-lg text-gray-300 max-w-4xl text-center mx-auto mb-12">
              Our team consists of cybersecurity experts, data scientists, and investigators with years of experience in digital forensics.
            </p>
            <div className="flex gap-8">
              <TeamMember name="Aayushman " role="Developer (Backend)" image="/images/teamMembers/aayushman.jpeg" />
              <TeamMember name="Arpit " role="Developer (Frontend)" image="/images/teamMembers/arpit.jpeg" />
              <TeamMember name="Kartik" role="Developer (Frontend)" image="/images/teamMembers/kartik.jpeg" />
              <TeamMember name="Abdul " role="Developer (ML)"  image="/images/teamMembers/abdul.jpeg" />
              <TeamMember name="Arpita" role="Designer and Content Manager" image="/images/teamMembers/arpita.jpeg" />
              <TeamMember name="Rishabh" role="Designer and Video Editor" image="/images/teamMembers/rishab.jpeg" />
            </div>
          </div>
        </section>
      </div>
