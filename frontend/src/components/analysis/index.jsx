...
export default function DataAnalysisPage() {
  ...
  const handleSubmit = (e) => {
    ...
    if (userData) {
      ...
      const totalComments = userData.posts.reduce((sum, post) => sum + post.comments, 0)
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex flex-col items-center justify-start p-4 space-y-8">
      <div className="bg-gray-800 rounded-lg shadow-2xl p-8 max-w-md w-full">
        <h1 className="text-3xl font-bold text-center mb-6 text-gray-100">Instagram Data Analysis</h1>
